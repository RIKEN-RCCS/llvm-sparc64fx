...
public:
  ...
  // [S64fx] isACE1/2() flags are exclusive, currently.
  bool isACE() const {assert(!(IsACE1&&IsACE2)); return (IsACE1 || IsACE2);}
  bool isACE1() const {return IsACE1;}
  bool isACE2() const {return IsACE2;}
